...
def train_stage(cfg: StageConfig, device: torch.device,
    ...
    for epoch in range(cfg.epochs):
        ...
        for batch_start in range(0, n_pairs, cfg.batch_size):
            ...
            # fp16 upsample + SegNet inference: ~19% faster on RTX 4060, same quality
            ...
            # STE in fp32 for gradient correctness
            ...
            seg_l = cfg.seg_loss_fn(seg_out, seg_targets_hard[idx.cpu()].long().to(device))
